...
//val env2 = createEnv2()
//
//fun mal_read5(para: String) : MalType {
//    return read_str(para)
//}
//
//fun eval_do(ast: ISeq, env: Env): MalType {
//    for (i in 1..ast.count() - 2) {
//        mal_eval5(ast.nth(i), env)
//    }
//    return mal_eval5(ast.seq().last(), env)
//}
//
...
//        mal_eval5(body, Env(env, symbols, s.seq()))
//    })
//}
//
//private fun eval_if(ast: ISeq, env: Env): MalType {
//    if (ast.nth(1).truthy()) {
//        return mal_eval5(ast.nth(2), env)
//    } else {
//        if (ast.count() > 3) {
//            return mal_eval5(ast.nth(3), env)
//        }
//        return NIL
//    }
//    return NIL
